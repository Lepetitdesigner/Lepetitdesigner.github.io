	...
	<div class="container">
		<header>
			...
			<nav>
				...
				<ul id="menu">
					<br><li><a href="index.php">Accueil</a></li><br>
					...
					<li><a href="precommander.php">Pré-commander</a></li><br>
				</ul>
			</nav>
		...
		<a class="retour" href="https://www.lepetitdesigner.fr/crea-web.php">Retour</a>
	</div>
